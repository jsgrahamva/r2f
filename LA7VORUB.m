LA7VORUB	;DALOI/JMC - Builder of HL7 Lab Results cont'd ;01/27/15  21:36
	;;5.2;AUTOMATED LAB INSTRUMENTS;**68,74,80,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 6
	;
...
OBR	;Observation Request segment for Lab Order
	...
	I LA("SUB")="CH",LA7RS="" D  ;WV
	. S LA7RS="F" ;WV
	. S I=1 ;WV
	. F  S I=$O(^LR(LRDFN,"CH",LRIDT,I)) Q:I<1  I $P(^(I),"^",10)=2 S LA7RS="C" ;WV
