PSORX1	;BIR/SAB-medication processing driver ;7:27 AM  1 Jan 2014
	;;7.0;OUTPATIENT PHARMACY;**7,22,23,57,62,46,74,71,90,95,115,117,146,139,135,182,195,233,268,300,170,320,326,324,334,251,WVEHR,LOCAL**;DEC 1997;Build 3
	;
...
OERR	N:$G(MEDP) PAT,POERR K PSOXFLG S (DFN,PSODFN)=+Y,PSORX("NAME")=$P(Y,"^",2)
	...
	;was;S SSN=$P(^DPT(PSODFN,0),"^",9) W !!?10,$C(7),PSORX("NAME")
	;was;W " ("_$E(SSN,1,3)_"-"_$E(SSN,4,5)_"-"_$E(SSN,6,9)_")" K SSN
	D ^VADPT W !!?10,$C(7),PSORX("NAME")," ",VA("PID")
	;End WorldVistA Change D ^VADPT W !!?10,$C(7),PSORX("NAME")," ",VA("PID")
