IBXS6 ; GENERATED FROM 'IB SCREEN6' INPUT TEMPLATE(#512), FILE 399;11/04/15
 D DE G BEGIN
...
C17F1 N X,X1,X2 S DIXR=1007 D C17X1(U) K X2 M X2=X D C17X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . D CMAEDALL^IBCU9(DA)
...
C22S S X="" G:DG(DQ)=X C22F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D ATTREND^IBCU1(DA,"","")
C22F1 N X,X1,X2 S DIXR=933 D C22X1(U) K X2 M X2=X D C22X1("O") K X1 M X1=X
 K X M X=X2 D
...
C22X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C22F2 S DIXR=934 D C22X2(U) K X2 M X2=X D C22X2("O") K X1 M X1=X
 K X M X=X2 D
...
C26S S X="" G:DG(DQ)=X C26F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D ATTREND^IBCU1(DA,"","")
C26F1 N X,X1,X2 S DIXR=933 D C26X1(U) K X2 M X2=X D C26X1("O") K X1 M X1=X
 K X M X=X2 D
 . N IBLNPRV I $$LNPRVFT^IBCEU7(X,.IBLNPRV) D FILE^DIE("E","IBLNPRV") Q
 G C26F2
C26X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C26F2 S DIXR=934 D C26X2(U) K X2 M X2=X D C26X2("O") K X1 M X1=X
 K X M X=X2 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . S X=X(1)=3
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
