DGX510 ; ;11/08/15
 ;;
1 N X,X1,X2 S DIXR=1153 D X1(U) K X2 M X2=X D X1("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X1(DION) K X
 ...
 S X=$G(X(1))
 Q
2 N X,X1,X2 S DIXR=1154 D X2(U) K X2 M X2=X D X2("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=1155 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=1156 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=1157 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X5(DION) K X
 ...
 S X=$G(X(1))
 Q
6 N X,X1,X2 S DIXR=1158 D X6(U) K X2 M X2=X D X6("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X6(DION) K X
 ...
 S X=$G(X(1))
 Q
7 N X,X1,X2 S DIXR=1159 D X7(U) K X2 M X2=X D X7("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X7(DION) K X
 ...
 S X=$G(X(1))
 Q
8 N X,X1,X2 S DIXR=1160 D X8(U) K X2 M X2=X D X8("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X8(DION) K X
 ...
 S X=$G(X(1))
 Q
9 N X,X1,X2 S DIXR=1161 D X9(U) K X2 M X2=X D X9("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X9(DION) K X
 ...
 S X=$G(X(1))
 Q
10 N X,X1,X2 S DIXR=1162 D X10(U) K X2 M X2=X D X10("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X10(DION) K X
 ...
 S X=$G(X(1))
 Q
11 N X,X1,X2 S DIXR=1204 D X11(U) K X2 M X2=X D X11("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X11(DION) K X
 ...
 S X=$G(X(1))
 Q
12 N X,X1,X2 S DIXR=1205 D X12(U) K X2 M X2=X D X12("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X12(DION) K X
 ...
 S X=$G(X(1))
 Q
13 N X,X1,X2 S DIXR=1206 D X13(U) K X2 M X2=X D X13("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X13(DION) K X
 ...
 S X=$G(X(1))
 Q
14 N X,X1,X2 S DIXR=1207 D X14(U) K X2 M X2=X D X14("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X14(DION) K X
 ...
 S X=$G(X(1))
 Q
15 N X,X1,X2 S DIXR=1208 D X15(U) K X2 M X2=X D X15("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X15(DION) K X
 ...
 S X=$G(X(1))
 Q
16 N X,X1,X2 S DIXR=1209 D X16(U) K X2 M X2=X D X16("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X16(DION) K X
 ...
 S X=$G(X(1))
 Q
17 N X,X1,X2 S DIXR=1210 D X17(U) K X2 M X2=X D X17("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X17(DION) K X
 ...
 S X=$G(X(1))
 Q
18 N X,X1,X2 S DIXR=1211 D X18(U) K X2 M X2=X D X18("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X18(DION) K X
 ...
 S X=$G(X(1))
 Q
19 N X,X1,X2 S DIXR=1212 D X19(U) K X2 M X2=X D X19("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X19(DION) K X
 ...
 S X=$G(X(1))
 Q
20 N X,X1,X2 S DIXR=1213 D X20(U) K X2 M X2=X D X20("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X20(DION) K X
 ...
 S X=$G(X(1))
 Q
21 N X,X1,X2 S DIXR=1214 D X21(U) K X2 M X2=X D X21("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X21(DION) K X
 ...
 S X=$G(X(1))
 Q
22 N X,X1,X2 S DIXR=1215 D X22(U) K X2 M X2=X D X22("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X22(DION) K X
 ...
 S X=$G(X(1))
 Q
23 N X,X1,X2 S DIXR=1216 D X23(U) K X2 M X2=X D X23("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X23(DION) K X
 ...
 S X=$G(X(1))
 Q
24 N X,X1,X2 S DIXR=1217 D X24(U) K X2 M X2=X D X24("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X24(DION) K X
 ...
 S X=$G(X(1))
 Q
25 N X,X1,X2 S DIXR=1218 D X25(U) K X2 M X2=X D X25("F") K X1 M X1=X
 I $G(X(2))]"" D
