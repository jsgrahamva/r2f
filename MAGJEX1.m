MAGJEX1 ;WIRMFO/JHC,ISI/JL VistARad RPC calls ; 01 Apr 2014  5:33 PM
 ;;3.0;IMAGING;**16,22,18,65,101,115,104,local**;Mar 19, 2002;Build 2225;Jul 12, 2011
...
OPENCASZ I 'CT,(REPLY["Attempting") S REPLY="4~Unable to retrieve images for Case #"_DAYCASE_"."
 ...
 . S DATAOUT=DATAOUT_U_MODIF_U_EXCAT_U_"|"_RIST_U_ALTPATH_U_ACQSITE_U_PROCDT_U_YNREVANN_U_YNMAMMO_U_STANUM_$$REGIONAL(.MAGS) ;ISI
 . I USELORES D
...
END Q  ;
 ;
REGIONAL(MAGS) ;ISI check if image is regional :=1
 Q:'$G(MAGS) ""  ;aft called JBFETCH^MAGJUTL2
 N IEN,LOC
 S IEN=+$P($G(MAGS(1)),U,4) Q:'IEN ""  ;MAG IEN 1st image
 S LOC=+$P($G(^MAG(2005,+IEN,0)),"^",3)          ;NETWORK LOCATION
 I $G(^MAG(2005.2,LOC,"REGIONAL")) Q "|1"
 Q ""
 ;
