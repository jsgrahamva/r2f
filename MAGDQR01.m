...
FIND(OUT,TAGS,RESULT,OFFSET,MAX) ; RPC = MAG CFIND QUERY
 ...
 . ;
 . L +^MAGDQR(2006.5732,0):1999999 ; Background process MUST wait
...
LOG(TYP,DETAIL,TXT) N D1,D2,D3,LOC,X
 ...
 L +^MAGDAUDT(2006.5733,DT,1,D1,1,D2):1999999 ; Background job MUST wait
 ...
 . L +^MAGDAUDT(2006.5733,DT,1,D1,1,D2,1,D3):1999999 ; Background job MUST wait
...
ADD(ROOT,F1,F2,VAL,DINUM) N D0,NAM,O,X
 ...
 L +@NAM:1999999 ; Background job MUST wait
 S X=$G(@NAM)
 S $P(X,"^",1,2)=F1_"^"_F2
