C0CRXN21 ; COMPILED XREF FOR FILE #176.002 ; 08/23/15
 ; 
 S DIKZK=2
 S DIKZ(0)=$G(^C0CRXN(176.002,DA,0))
 S X=$P($G(DIKZ(0)),U,11)
 I X'="" K ^C0CRXN(176.002,"XATV",$E(X,1,30),DA)
 S X=$P($G(DIKZ(0)),U,3)
 I X'="" K ^C0CRXN(176.002,"NDC",$E(X,1,30),DA)
 S X=$P($G(DIKZ(0)),U,1)
 I X'="" K ^C0CRXN(176.002,"XATN",$E(X,1,30),DA)
CR1 S DIXR=737
 K X
 S X(1)=$P(DIKZ(0),U,1)
 S X(2)=$P(DIKZ(0),U,3)
 ...
 . K ^C0CRXN(176.002,"COMB",X(1),X(2),DA)
CR2 S DIXR=1122
 K X
 S DIKZ(0)=$G(^C0CRXN(176.002,DA,0))
 S X(1)=$P(DIKZ(0),U,9)
