GMTSOBI	; SLC/KER - HS Object - Import/Install    ;6:54 AM  9 Jan 2012
	;;2.7;Health Summary;**58,89,WVEHR,LOCAL**;Oct 20, 1995;Build 3;WorldVistA 30-June-08
	;
...
DELERR	; Delete on Error
	...
	. D DI(+($G(GMTSDAT)),"^GMT(142,"),DI(+($G(GMTSDAO)),"^GMT(142.5,")
