DG53800P	;BHM/CKN - POST INSTALL ROUTINE TO UPDATE IPP FIELD IN TREATING FACILITY FILE 391.91 ;8:35 AM  8 Jul 2012
	;;5.3;Registration;**800,WVEHR,LOCAL**;Aug 13, 1993;Build 3
	;
...
PROCESS	;
	...
	;Begin WorldVistA Change ;so
	;was;S INSTIEN=$O(^DIC(4,"D","200MH","")) ;Institution file ien for 200MH
	S INSTIEN=$O(^DIC(4,"D","200MH","")) ;Institution file ien for 200MH
	I 'INSTIEN S QFLG=1 G WV
	...
	. D ^DIE K DIE,DA,DR
	;Begin WorldVistA Change ;so
	;was;I QFLG S ^XTMP("DG53800P","@@","PROCESS STOPPED")=$$NOW^XLFDT() Q
WV	I QFLG S ^XTMP("DG53800P","@@","PROCESS STOPPED")=$$NOW^XLFDT() Q
	;End WorldVistA Change
