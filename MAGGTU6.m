MAGGTU6 ;WOIFO/GEK,ISI/JL - Silent Utilities ; 01 Apr 2014 2:30pm
 ;;3.0;IMAGING;**24,8,48,45,20,46,59,72,93,local**;Dec 02, 2009;Build 2
...
SHARE(MAGRY,TYPE) ;RPC [MAG GET NETLOC]
 ...
 N TMP,I,DATA0,DATA2,DATA3,DATA6,INFO,VALUE,STYP,PHYREF,STA
 ...
 . ;;EHS/MUK;;UJO*1.0*131;;2/12/2012;; Commented ["I STYP'="URL" Q:(PHYREF[".")"]
 ...
 . S STA=+$P(DATA0,"^",10),STA=+$G(^MAG(2006.1,STA,0)),STA=$$STA^XUAF4(STA) ;ISI- STATION NUM
 . S $P(INFO,"^",10)=$G(^MAG(2005.2,I,"REGIONAL"))_"|"_$G(STA)
