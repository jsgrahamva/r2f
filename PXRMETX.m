PXRMETX	; SLC/PJH - Run Extract for QUERI ;6:31 AM  30 Aug 2015
	;;2.0;CLINICAL REMINDERS;**4,6,26,WVEHR,LOCAL**;Feb 04, 2005;Build 1
	;
...
ACAD	;Auto CAD entry point
	D AUTO("VOE DOQ-IT CAD EXTRACTION","Y")
	Q
	;
ADM	;Auto DM entry point
	D AUTO("VOE DOQ-IT DM EXTRACTION","Y")
	Q
	;
AHF	;Auto HF entry point
	D AUTO("VOE DOQ-IT HF EXTRACTION","Y")
	Q
	;
AHTN	;Auto HTN entry point
	D AUTO("VOE DOQ-IT HTN EXTRACTION","Y")
	Q
	;
APC	;Auto PC entry point
	D AUTO("VOE DOQ-IT PC EXTRACTION","Y")
	Q
