LEXAR7	;ISL/KER - Look-up Response (MAIL) ;1:13 PM  29 Aug 2015
	;;2.0;LEXICON UTILITY;**9,25,73,80,WVEHR,LOCAL**;Sep 23, 1996;Build 1
	;
...
MAILQ	; End of MAILMAN
	...
	;WAS;K ^TMP("LEXSEND",$J),^TMP("LEXMSG",$J),DIFROM,LEXA,XCNP,XMDUZ,XMZ,XMSUB,XMY,XMTEXT,XMDUZ,XMSCR,REF, Q
