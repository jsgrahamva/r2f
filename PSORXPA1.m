PSORXPA1	;BIR/SAB - listman partial prescriptions ;2:09 PM  30 Mar 2014
	;;7.0;OUTPATIENT PHARMACY;**11,27,56,77,130,152,181,174,287,385,WVEHR,LOCAL**;DEC 1997;Build 3
	;
	...
	D ^DIC K DIC
	S PSOZAF=+Y  ;vQuits if AUTOFINISH,RX not a user
	I $P($G(^PSRX(RXN,"OR1")),"^",5)=$G(PSOZAF) S VALMBCK="",VALMSG="Partial option is not available for Autofinshed Rxs" K PSOZAF Q
