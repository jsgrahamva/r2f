IBXS7 ; GENERATED FROM 'IB SCREEN7' INPUT TEMPLATE(#513), FILE 399;11/04/15
 D DE G BEGIN
...
C22F1 N X,X1,X2 S DIXR=1007 D C22X1(U) K X2 M X2=X D C22X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . D CMAEDALL^IBCU9(DA)
...
C27S S X="" G:DG(DQ)=X C27F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D ATTREND^IBCU1(DA,"","")
C27F1 N X,X1,X2 S DIXR=933 D C27X1(U) K X2 M X2=X D C27X1("O") K X1 M X1=X
 K X M X=X2 D
...
C27X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C27F2 S DIXR=934 D C27X2(U) K X2 M X2=X D C27X2("O") K X1 M X1=X
 K X M X=X2 D
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D ATTREND^IBCU1(DA,"","")
C31F1 N X,X1,X2 S DIXR=933 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 K X M X=X2 D
 . N IBLNPRV I $$LNPRVFT^IBCEU7(X,.IBLNPRV) D FILE^DIE("E","IBLNPRV") Q
 G C31F2
C31X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C31F2 S DIXR=934 D C31X2(U) K X2 M X2=X D C31X2("O") K X1 M X1=X
 K X M X=X2 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . S X=X(1)=3
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
