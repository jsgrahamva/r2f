XUS2	;SF/RWF - TO CHECK OR RETURN USER ATTRIBUTES ;7:10 AM  2 Apr 2014
	;;8.0;KERNEL;**59,180,313,419,437,574,WVEHR,LOCAL**;Jul 10, 1995;Build 3
...
VERED	; VERIFY CODE EDIT From DD
	;Begin WorldVistA change
	;was;N DIR,DIR0,XUAUTO,XUSVCMIN,XUSVCACCT S XUSVCACCT=$$SVCACCT(DA),XUSVCMIN=$S(+XUSVCACCT:12,1:8)
	N ASKINGVC,DIR,DIR0,XUAUTO,XUSVCMIN,XUSVCACCT S XUSVCACCT=$$SVCACCT(DA),XUSVCMIN=$S(+XUSVCACCT:12,1:8)
	S ASKINGVC=1
	;End WorldVistA change
	I "Nn"[$E(X,1) S X="" Q
	I "Yy"'[$E(X,1) K X Q
