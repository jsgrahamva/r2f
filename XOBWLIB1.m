XOBWLIB1	;ALB/MJK - HWSC :: Utilities Library ;2:57 PM  8 Feb 2014
	;;1.0;HwscWebServiceClient;**LOCAL**;September 13, 2010;Build 8
	;
	QUIT
	;
...
IMPORT(XOBDIR,XOBFILE)	; -- import Cache-exported XML file into Cache
	...
	; insert test for non-Cache
	I '$$VWGTM Q "0^not a Cache system"
	;END LOCAL MOD
...
DISPSRVS	; -- display servers
	...
	QUIT
	;
VWGTM()	; WorldVistA change to see if Cache Objects are being used ;LOCAL
	; 0=No
	; 1=Yes
	Q +$G(^XTV(8989.3,1,250000))
