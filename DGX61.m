...
C5F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1176,1177,1178,1179,1180,1230,1231,1232,1233,1234,1235,1236,1237,1238,1239,1240,1241,1242,1243,1244,1245,1246,1247,1248,1249 S DIEZRXR(45.05,DIXR)=""
 Q
...
C17F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1176 S DIEZRXR(45.05,DIXR)=""
 Q
...
C42F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1246 S DIEZRXR(45.05,DIXR)=""
 Q
...
C47F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1247 S DIEZRXR(45.05,DIXR)=""
 Q
...
C52F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1248 S DIEZRXR(45.05,DIXR)=""
 Q
