ORRDI1	;SLC/JMH - RDI routines for API supporting CDS data; 3/24/05 2:31 [8/11/05 6:25am] ;04/06/12  09:08
	;;3.0;ORDER ENTRY/RESULTS REPORTING;**232,294,306,WVEHR,LOCAL**;Dec 17, 1997;Build 2
	;
GET(DFN,DOMAIN)	;API for packages to call in order to get data from HDR for
	...
	;BEGIN WorldVistA change 08/3/15  //kt,DJW
	;WAS; I $$DOWNXVAL^ORRDI2 D  Q -1   
	I $$DOWNXVAL^ORRDI2!'$$VWGTM^XOBWLIB D  Q -1  
	.;END WorldVistA change 08/3/15
