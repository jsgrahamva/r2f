PSBOMH1	;BIRMINGHAM/EFC-MAH ;5:35 AM  3 Nov 2015
	;;3.0;BAR CODE MED ADMIN;**6,3,9,11,26,38,45,51,50,57,67,64,72,WVEHR,LOCAL**;Mar 2004;Build 1
...
EN	;
	...
	....;WAS;I $L(PSBLINE2)<=90 S ^TMP("PSB",$J,PSBWEEK,PSBORD,"AT",X+2)=PSBLINE2 S:$$GET1^DIQ(53.79,PSBIEN_",",.24)'="" ^TMP("PSB",$J,PSBWEEK,PSBORD,"AT",X+3)="      "_PSBRTXTW
