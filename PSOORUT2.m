PSOORUT2	;ISC BHAM/SAB - build listman screen ;5:18 AM  19 Jul 2015
	;;7.0;OUTPATIENT PHARMACY;**11,146,132,182,233,243,261,268,264,305,390,WVEHR,LOCAL**;DEC 1997;Build 1
	;
...
REMOTE	;
	...
	;WAS;I $T(GET^ORRDI1)]"" S PSOSIEN=$G(IEN) D GET^ORRDI1(DFN,"ART") S IEN=PSOSIEN K PSOSIEN D
	I $T(GET^ORRDI1)]"" S PSOSIEN=$G(IEN) N VW S VW=$$GET^ORRDI1(DFN,"ART") S IEN=PSOSIEN K PSOSIEN D
