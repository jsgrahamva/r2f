PSORXRP1	;BIR/SAB-rx speed reprint listman ;10:41 AM  2 Apr 2014
	;;7.0;OUTPATIENT PHARMACY;**11,27,120,156,148,367,WVEHR,LOCAL**;DEC 1997;Build 3
	;
...
RX	;process reprint request
	...
	S DIC="^VA(200,",DIC(0)="QEZ",X="AUTOFINISH,RX" D ^DIC K DIC
	S PSOZAF=+Y
	I $P($G(^PSRX($P(PSOLST(ORN),"^",2),"OR1")),"^",5)=$G(PSOZAF) W $C(7),!!,"Rx "_$$GET1^DIQ(52,$P(PSOLST(ORN),"^",2),.01)_" is an Autofinish,Rx and labels can not be reprinted." K PSOZAF D PAUSE^VALM1 Q
