...
C2F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1153,1154,1155,1156,1157,1158,1159,1160,1161,1162,1204,1205,1206,1207,1208,1209,1210,1211,1212,1213,1214,1215,1216,1217,1218 S DIEZRXR(45.02,DIXR)=""
 Q
...
C26F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1153 S DIEZRXR(45.02,DIXR)=""
 Q
...
C36F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1155 S DIEZRXR(45.02,DIXR)=""
 Q
...
C46F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1156 S DIEZRXR(45.02,DIXR)=""
 Q
