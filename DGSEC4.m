DGSEC4	;ALB/MM,JAP - Utilities for record access & sensitive record processing;10/6/99 ; 10/26/05 12:46pm
	;;5.3;Registration;**249,281,391,471,684,699,LOCAL**;Aug 13, 1993;Build 8
	;
...
SENS(DGSENS,DFN,DGDUZ,DDS,DGSENFLG)	;Determine if sensitive record
	...
	S DGSENS(1)=0
	;BEGIN LOCAL MOD WV/DJW 6/2011
AUDIT	I $G(DFN)>0,$T(ACCESSED^DIET)'="" D ACCESSED^DIET(2,DFN)
	;END LOCAL MOD WV/DJW 6/2011
	I $D(DGSENFLG) Q
