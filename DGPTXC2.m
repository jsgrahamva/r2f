DGPTXC2 ; ;09/03/15
 ;;
1 N X,X1,X2 S DIXR=28 D X1(U) K X2 M X2=X D X1("F") K X1 M X1=X
...
X1(DION) K X
 ...
 S X=$G(X(1))
 Q
2 N X,X1,X2 S DIXR=29 D X2(U) K X2 M X2=X D X2("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=30 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=31 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=32 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X5(DION) K X
 ...
 S X=$G(X(1))
 Q
6 N X,X1,X2 S DIXR=33 D X6(U) K X2 M X2=X D X6("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X6(DION) K X
 ...
 S X=$G(X(1))
 Q
7 N X,X1,X2 S DIXR=34 D X7(U) K X2 M X2=X D X7("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X7(DION) K X
 ...
 S X=$G(X(1))
 Q
8 N X,X1,X2 S DIXR=35 D X8(U) K X2 M X2=X D X8("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X8(DION) K X
 ...
 S X=$G(X(1))
 Q
9 N X,X1,X2 S DIXR=36 D X9(U) K X2 M X2=X D X9("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X9(DION) K X
 ...
 S X=$G(X(1))
 Q
10 N X,X1,X2 S DIXR=37 D X10(U) K X2 M X2=X D X10("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X10(DION) K X
 ...
 S X=$G(X(1))
 Q
11 N X,X1,X2 S DIXR=400 D X11(U) K X2 M X2=X D X11("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X11(DION) K X
 ...
 S X=$G(X(1))
 Q
12 N X,X1,X2 S DIXR=401 D X12(U) K X2 M X2=X D X12("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X12(DION) K X
 ...
 S X=$G(X(1))
 Q
13 N X,X1,X2 S DIXR=402 D X13(U) K X2 M X2=X D X13("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X13(DION) K X
 ...
 S X=$G(X(1))
 Q
14 N X,X1,X2 S DIXR=403 D X14(U) K X2 M X2=X D X14("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X14(DION) K X
 ...
 S X=$G(X(1))
 Q
15 N X,X1,X2 S DIXR=404 D X15(U) K X2 M X2=X D X15("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
