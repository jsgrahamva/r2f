...
X1(DION) K X
 ...
 S X=$G(X(1))
 Q
2 N X,X1,X2 S DIXR=1155 D X2(U) K X2 M X2=X D X2("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=1156 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=1157 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=1158 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(2))]"" D
