LA7VOBXA	;DALOI/JMC - LAB OBX Segment message builder (cont'd) ;01/27/15  21:34
	;;5.2;AUTOMATED LAB INSTRUMENTS;**46,70,64,68,74,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 6
	;
...
OBX6	; Build OBX-6 sequence - Units
	...
	. I LA7INTYP=80 D  ;WV
	. . ;S $P(LA7Y,$E(LA7ECH,1),1)=LA7Y ;WV
	. . ;S $P(LA7Y,$E(LA7ECH,1),2)=LA7Y ;WV
	. . ;S $P(LA7Y,$E(LA7ECH,1),3)="UCUM" ;WV
