...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=2,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 ...
 I $D(^(.121)) S %Z=^(.121) S %=$P(%Z,U,1) S:%]"" DE(12)=% S %=$P(%Z,U,2) S:%]"" DE(14)=% S %=$P(%Z,U,3) S:%]"" DE(16)=% S %=$P(%Z,U,7) S:%]"" DE(9)=% S %=$P(%Z,U,8) S:%]"" DE(11)=% S %=$P(%Z,U,9) S:%]"" DE(7)=%
...
X5 K:$L(X)>20!($L(X)<4) X
 ...
 ;
6 S DQ=7 ;@155
7 D:$D(DG)>9 F^DIE17,DE S DQ=7,DW=".121;9",DV="RSX",DU="",DLB="TEMPORARY ADDRESS ACTIVE?",DIFLD=.12105
