MAGGTIA1 ;WOIFO/GEK/SG,ISI/JL,NST - RPC Call to Add Image File entry ; 01 APR 2014 1:42pm
 ;;3.0;IMAGING;**21,8,59,93,local**;Nov 05, 2009;Build 26
...
C1 ; we jump here if we already had a Filename sent
 ...
 . Q
 ;
 D NWRKITEM^ISINVRS1(MAGGDA) ;ISI operation - add new storage work item
 ; Call ISI routine to change Object Type of Image if it is ECG. ;ISI
 I $L($T(CHKECG^ISIV2)) D CHKECG^ISIV2(MAGGDA) ; ISI
 D BACKUP^ISIV1(.MAGRY,MAGGDA)
 D CLEAN
 Q
 ;
CLEAN ;
