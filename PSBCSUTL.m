PSBCSUTL	;BIRMINGHAM/TEJ- BCMA-HSC COVER SHEET UTILITIES ;5:41 AM  3 Nov 2015
	;;3.0;BAR CODE MED ADMIN;**16,13,38,32,50,60,58,68,70,80,WVEHR,LOCAL**;Mar 2004;Build 1
...
PAINCMT(DFN)	;;Add comment if Pain Score entered in BCMA was marked "Entered in Error" in Vitals.
	...
	.....;WAS;I PSBTMDF>=-($S($G(DILOCKTM)>0:DILOCKTM,1:3)),PSBTMDF<=$S($G(DILOCKTM)>0:DILOCKTM,1:3) S PSBDUZ=$P(^TMP("PSBGMV",$J,PSBGMR),U,10) D  ;User who marked Pain Score Entered in error, PSB*3*80
