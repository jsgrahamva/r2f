DGX78 ; ;11/08/15
 ;;
1 N X,X1,X2 S DIXR=1225 D X1(U) K X2 M X2=X D X1("F") K X1 M X1=X
...
X1(DION) K X
 ...
 S X=$G(X(1))
 Q
2 N X,X1,X2 S DIXR=1226 D X2(U) K X2 M X2=X D X2("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=1227 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=1228 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=1229 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
