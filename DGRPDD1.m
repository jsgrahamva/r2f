DGRPDD1	;ALB/JDS,LBD - INPUT SYNTAX CHECKS - FORMERLY DGINP ;4:57 AM  25 Jul 2015
	;;5.3;Registration;**72,136,244,621,797,866,WVEHR,LOCAL**;AUG 13, 1993;Build 1
	;
	;
...
PSEU	;WAS;I $D(DPTIDS(.03)),$D(DPTX) S NAM=DPTX,DOB=DPTIDS(.03)
