ISINCF02 ;ISI/NST -RPC for ISI FORM file ; 07 Mar 2014 3:59 PM
 ...
 ;            ISIRY(1)    = "^" delimited string with all field names in ISI FORM file (#9999910)
 ;                              excluding word-processing fields
 ;            ISIRY(2..n) = "^" delimited string with values of fields listed in ISIRY(1) 
 
 ; 
CFLIST(ISIRY,ISIPARAM) ; RPC [ISIN LIST FORM]
 N ACTIVE,IEN
 N RESDEL
