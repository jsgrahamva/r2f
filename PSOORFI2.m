PSOORFI2	;BIR/BHW-finish cprs orders cont. ;2:34 PM  7 Sep 2015
	;;7.0;OUTPATIENT PHARMACY;**7,15,23,27,46,130,146,177,222,225,338,313,408,WVEHR,LOCAL**;DEC 1997;Build 4
	;
...
PROFILE	;display med profile
	...
	;WAS;W !!! K MEDP,DIR,DUOUT,DIRUT,DTOUT S DIR(0)="Y",DIR("B")="Yes",DIR("A")="Do you want to see Medication Profile" D ^DIR K DIR Q:$D(DIRUT)!('Y)
...
INST	;Select Institution
	...
	;Begin WorldVistA change
	;WAS;S PSCT=0 F PSIR=0:0 S PSIR=$O(^PS(59,PSOSITE,"INI1",PSIR)) Q:'PSIR  I $P($G(^PS(59,PSOSITE,"INI1",PSIR,0)),"^") S PSCT=PSCT+1 I PSCT=1 S PSOPINST=$P($G(^(0)),"^")
