PSOORFI3	;BIR/RTR-finish CPRS orders by Clinic ;3:25 AM  23 Aug 2015
	;;7.0;OUTPATIENT PHARMACY;**15,27,32,46,84,99,130,117,139,172,225,300,384,372,WVEHR,LOCAL**;DEC 1997;Build 2
	;
...
L1	;Lock single order
	...
	;WAS;K PSOMSG D PSOL^PSSLOCK(+ORD_"S") I '$G(PSOMSG) W !!,$S($P($G(PSOMSG),"^",2)'="":$P($G(PSOMSG),"^",2),1:"This Order is being edited by another person."),! K DIR S DIR(0)="E",DIR("A")="Press Return to Continue" D ^DIR K DIR
