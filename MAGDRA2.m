MAGDRA2 ;WOIFO/LB -Routine for DICOM fix  [ 06/20/2001 08:56 ] ; 05/18/2007 11:23
 ;;3.0;IMAGING;**10,11,51,54**;03-July-2009;Build 2;Build 1424
...
READ ;
 ...
 ;
PTINFO() ;
 N INFO,MAGOUT,NMFIELD
 I '$D(MAGDFN) Q ""
 I $$SITE^VASITE()["OROVILLE" D  Q INFO
 . N DFN S DFN=MAGDFN,INFO="" D DEM^VADPT
 . I $G(VA("PID"))'="" S INFO=$G(VADM(1))_"^"_$TR(VA("PID"),"-")
 . E  S INFO=$G(VADM(1))_"^"_$P($G(VADM(2)),"^")
 . Q
 S NMFIELD=".01"
 I '($G(^DD(2,400000011,0))="") S NMFIELD=400000011  ;SAF ISI - Get english name if exists, otherwise get Arabic name
 D GETS^DIQ(2,MAGDFN,NMFIELD_";.09","E","MAGOUT","MAGERR")
 I $G(MAGOUT(2,MAGDFN_",",NMFIELD,"E"))="" S NMFIELD=.01 D GETS^DIQ(2,MAGDFN_",",NMFIELD_";.09","E","MAGOUT","MAGERR")
 I $D(MAGERR) Q ""
 I $D(MAGOUT) D  Q INFO
 . S INFO=$G(MAGOUT(2,MAGDFN_",",NMFIELD,"E"))
