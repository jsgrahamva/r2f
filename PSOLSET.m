PSOLSET	;BHAM ISC/SAB - site parameter set up ;10:29 AM  2 Apr 2014
VERS	;;7.0;OUTPATIENT PHARMACY;**10,22,32,40,120,247,359,367,WVEHR,LOCAL**;DEC 1997;Build 3
	;
...
LASK	I $G(PSOPIOST),$D(^%ZIS(2,PSOPIOST,55,"B","LL")) G FDAPRT
	...
	;AutoFinish fax additions begin here
	K PSOAFFXP,PSOAFFXL
	I PSOLAP["FAX" D
	...
	;Autofinish fax additions end here
