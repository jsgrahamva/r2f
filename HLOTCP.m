HLOTCP	;ALB/CJM- TCP/IP I/O - 10/4/94 1pm ;5:09 AM  24 Mar 2014
	;;1.6;HEALTH LEVEL SEVEN;**126,131,134,137,138,139,146,153;LOCAL**;Build 3;Build 11
	;Per VHA Directive 2004-038, this routine should not be modified.
	;Modified for WorldVistA EHR by Lloyd Milligan, Sea Island Systems
	;
...
ZB28	....;
	...
	;SIS/LM - Insert the following for GT.M / Linux OS Server
	E  I $G(HLCSTATE("SERVER")),LOGICAL="GTM$LNX" D
	.;Linux OS server (xinetd or etc.)
	.S HLCSTATE("TCP BUFFER SIZE")=256
	.S HLCSTATE("FLUSH")=$S(HLCSTATE("SYSTEM","OS")="GT.M":"!",1:"")
	.S HLCSTATE("CONNECTED")=1
	.S HLCSTATE("DEVICE")=$P
	.U HLCSTATE("DEVICE"):(NOWRAP:NODELIMITER)
	.Q
	;SIS/LM - End inserted block
	;End WorldVistA change
	E  D  ;any other system but Cache or DSM
	.; SIS/LM - Also not a Linux server, therefore presumed to be a client ->
	.S HLCSTATE("FLUSH")=$S(HLCSTATE("SYSTEM","OS")="GT.M":"!",1:"")
	.; SIS/LM - End insert
	.S HLCSTATE("TCP BUFFER SIZE")=256
