...
C6F1 N X,X1,X2 S DIXR=927 D C6X1(U) K X2 M X2=X D C6X1("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C7F1 N X,X1,X2 S DIXR=928 D C7X1(U) K X2 M X2=X D C7X1("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C11F1 S DIEZRXR(70.03,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=490 S DIEZRXR(70.03,DIXR)=""
 Q
