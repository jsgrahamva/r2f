PSBRPC2	;BIRMINGHAM/EFC-BCMA RPC BROKER CALLS ;7:20 AM  4 Apr 2014
	;;3.0;BAR CODE MED ADMIN;**6,3,16,32,61,WVEHR,LOCAL**;Mar 2004;Build 3
	;
...
BAGDTL(RESULTS,PSBUID,PSBORD)	; bag detail
	...
	.;Begin WorldVistA change
	.;was;I $QS(PSBQRY,2)="C",$E($P(@$Q(@PSBQRY,-1),U,1),1,12)=$E($P(@PSBQRY,U,1),1,12),$P(@$Q(@PSBQRY,-1),U,2)=$P(@PSBQRY,U,2) S X=$P(@PSBQRY,U,4),$P(RESULTS(PSBCNT-1),U,4)=X Q
