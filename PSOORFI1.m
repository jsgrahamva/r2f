PSOORFI1	;BIR/SAB - finish OP orders from OE/RR continued ;2:26 PM  7 Sep 2015
	;;7.0;OUTPATIENT PHARMACY;**7,15,23,27,32,44,51,46,71,90,108,131,152,186,210,222,258,260,225,391,408,WVEHR,LOCAL**;DEC 1997;Build 4
	;
...
DSPL	K ^TMP("PSOPO",$J),CLOZPAT,PSOPRC,PSODSPL
	...
	I '$P(OR0,"^",9)&($G(PSOAFYN)="Y") D DISPD^PSOAFIN G DSPL
