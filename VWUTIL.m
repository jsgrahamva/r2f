VWUTIL	;WVEHR/Maury Pepper/Skip Ormsby- World VistA Utilities;2:37 PM  11 Aug 2016;;;; 11/5/12 1:21pm
	;;1.0;WORLD VISTA;**250001,250002,WVEHR,LOCAL**;;Build 1
	;
...
REGMU	; Changes to Patient Registration for MU
	...
	Q
	;
EON	; Multibuild POST-INSTALL ROUTINE to turn echo back on
	X ^%ZOSF("EON")
	Q
WVRPC	;Add WorldVistA's RPCs
	N RPC
	F I=1:1 S RPC=$T(RPCTBL+I) Q:$P(RPC,";;",2)="EOD"  D
	. N RPCIEN S RPCIEN=0
	. S RPC=$P(RPC,";;",2)
	. S RPCIEN=$$FIND1^DIC(8994,"","BQX",RPC)
	. I 'RPCIEN Q
	. N MENU S MENU="OR CPRS GUI CHART"
	. S FDA(19,"?1,",.01)=MENU
	...
	Q
	;
RPCTBL	;Table of WorldVistA's RPCs
	;;C0P ERX ALERT RPC
	;;C0P ERX ORDER RPC
	;;C0P ERX PULLBACK
	;;ORWPS COVER
