...
2 D:$D(DG)>9 F^DIE17,DE S DQ=2,DW=".11;12",DV="FXOa",DU="",DLB="ZIP+4",DIFLD=.1112
 ...
 S DE(DW)="C2^IBXSC18",DE(DW,"INDEX")=1
 G RE
...
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW=".121;9",DV="RSX",DU="",DLB="TEMPORARY ADDRESS ACTIVE?",DIFLD=.12105
 S DE(DW)="C6^IBXSC18",DE(DW,"INDEX")=1
 S DU="Y:YES;N:NO;"
 G RE
...
8 D:$D(DG)>9 F^DIE17,DE S DQ=8,DW=".121;7",DV="DX",DU="",DLB="TEMPORARY ADDRESS START DATE",DIFLD=.1217
 S DE(DW)="C8^IBXSC18",DE(DW,"INDEX")=1
 G RE
...
10 D:$D(DG)>9 F^DIE17,DE S DQ=10,DW=".121;8",DV="DX",DU="",DLB="TEMPORARY ADDRESS END DATE",DIFLD=.1218
 S DE(DW)="C10^IBXSC18",DE(DW,"INDEX")=1
 G RE
...
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW=".121;1",DV="FX",DU="",DLB="TEMPORARY STREET [LINE 1]",DIFLD=.1211
 S DE(DW)="C11^IBXSC18",DE(DW,"INDEX")=1
 G RE
...
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,DW=".121;2",DV="FX",DU="",DLB="TEMPORARY STREET [LINE 2]",DIFLD=.1212
 S DE(DW)="C13^IBXSC18",DE(DW,"INDEX")=1
 G RE
...
15 D:$D(DG)>9 F^DIE17,DE S DQ=15,DW=".121;3",DV="FX",DU="",DLB="TEMPORARY STREET [LINE 3]",DIFLD=.1213
 S DE(DW)="C15^IBXSC18",DE(DW,"INDEX")=1
 G RE
...
16 D:$D(DG)>9 F^DIE17,DE S DQ=16,DW=".121;4",DV="FX",DU="",DLB="TEMPORARY CITY",DIFLD=.1214
 S DE(DW)="C16^IBXSC18",DE(DW,"INDEX")=1
 G RE
...
17 D:$D(DG)>9 F^DIE17,DE S DQ=17,DW=".121;5",DV="*P5'X",DU="",DLB="TEMPORARY STATE",DIFLD=.1215
 S DE(DW)="C17^IBXSC18",DE(DW,"INDEX")=1
 S DU="DIC(5,"
 G RE
...
18 D:$D(DG)>9 F^DIE17,DE S DQ=18,DW=".121;12",DV="FOX",DU="",DLB="TEMPORARY ZIP+4",DIFLD=.12112
 ...
 S DE(DW)="C18^IBXSC18",DE(DW,"INDEX")=1
 G RE
