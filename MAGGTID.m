MAGGTID ;WOIFO/SRR/RED/SAF/GEK/SG - Deletion of Images and Pointers ; 3/19/09 8:27am
 ;;3.0;IMAGING;**8,59,93**;Nov 05, 2009;Build 2
 ...
 Q
 ;
IMAGEDEL(MAGGRY,MAGIEN,MAGGRPDF,REASON,DATA) ;RPC [MAGG IMAGE DELETE]
 ...
 ; DATA      Added for ISI-S processing.  it was used to force Delete.
 ;           but in this version of MAGGTID,  force delete
 ;           is automatic (the 3rd param of '1' means force delete);
 N IEN,Y,RY
