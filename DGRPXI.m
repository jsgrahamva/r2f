DGRPXI ; GENERATED FROM 'DGRP V1 ENTER/EDIT ANNUAL INC' INPUT TEMPLATE(#1726), FILE 408.21;08/23/15
 D DE G BEGIN
...
BEGIN S DNM="DGRPXI",DQ=1
 ...
 M DIEZAR=^DIE(1726,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1726,U="^"
