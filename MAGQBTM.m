MAGQBTM ;WOIFO/RMP - REMOTE Task SERVER Program [ 04/07/2016 11:45 ]
 ;;3.0;IMAGING;**1,7,8,20,81,local**;May 17, 2007;Build 2
...
DEQUEUE(QUE,RESULT) ;
 ...
 ;
 ; -- get next qptr to process ISI/BT
 ;S QPTR=$O(^MAGQUEUE(2006.03,"C",PLACE,QUE,QPTR))
 N NQPTR S NQPTR=$O(^MAGQUEUE(2006.03,"C",PLACE,QUE,QPTR))
 ;
 I NQPTR="",QPTR,QUE="IMPORT" D  ;check NOT_PROCESSED items
 . N NPQUE S NPQUE=$O(^MAGQUEUE(2006.03,"D",PLACE,"IMPORT","NOT_PROCESSED"," "),-1)
 . I NPQUE S $P(^MAGQUEUE(2006.031,QPTR2,0),U,2)=NPQUE-1,NQPTR=NPQUE
 ;
 S QPTR=NQPTR
 ;
 I QPTR="" D  Q
