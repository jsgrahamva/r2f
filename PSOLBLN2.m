PSOLBLN2	;BHAM ISC/RTR - NEW LABEL TRAILER ;8:06 PM  3 Oct 2012
	;;7.0;OUTPATIENT PHARMACY;**92,107,110,305,326,WVEHR,LOCAL**;DEC 1997;Build 3;WorldVistA 30-June-08
	;
...
PRINT	S PSOTRDFN=$P(VADM(2),"^"),PSOTRDFN=$S(PSOTRDFN]"":PSOTRDFN,1:"Unavailable") S Y=DT X ^DD("DD") S EDT=Y
	...
	;Begin WorldVistA Change ;PSO*7.0*208
	;was;S (PSNONARR,PSNOADDR,PSNOBOTH)=0 F TTT=1:1 Q:$G(PSNOBOTH)  D
	I $G(PSOAFYN)'="Y" S (PSNONARR,PSNOADDR,PSNOBOTH)=0 F TTT=1:1 Q:$G(PSNOBOTH)  D
