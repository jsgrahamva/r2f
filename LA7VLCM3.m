LA7VLCM3	;DALOI/JDB - LAB CODE MAPPING FILE UTILITIES ;12/27/11  09:57
	;;5.2;AUTOMATED LAB INSTRUMENTS;**74,LOCAL,WVEHR**;Sep 27, 1994;Build 2
	;
	Q
	;
CODSETOK(R6247,R624701,CODE,CS,DISP)	;
	...
	;
	I LAT ;reset $T
	;BEGIN WorldVistA Change ; DJW 6/8/2015
	;CALLED FROM A DO IN INPUT TRANSFORM OF IDENTIFIER field IN 62.4701
	;i.e. LAB CODE MAPPING File#62.47 multiple IDENTIFIER, field #.01
	;^DD(62.4701,.01,0)="IDENTIFIER^MFX^^0;1^K:$L(X)>30!($L(X)<1) X
	;D:$G(X)]"""" CODSETOK^LA7VLCM3(DA(1),$G(DA),X,,1)"
	;
	;was; Q OK
	Q:$Q OK Q
