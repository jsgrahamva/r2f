TMGUSRI3	;TMG/kst/SACC-compliant USER INTERFACE API FUNCTIONS ;10/8/12
	        ;;1.0;TMG-LIB;**1,17**;07/17/12;Build 8
	;
	...
	;"=======================================================================
	;
	;"IENSelector(PIENARRAY,PRESULTS,FILE,FIELDS,WIDTHS,HEADER,SORTFIELDS,SAVEARRAY)
