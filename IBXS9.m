IBXS9 ; GENERATED FROM 'IB SCREEN9' INPUT TEMPLATE(#1769), FILE 399;09/13/15
 D DE G BEGIN
...
BEGIN S DNM="IBXS9",DQ=1
 ...
 M DIEZAR=^DIE(1769,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1769,U="^"
