PSODISPS	;BIR/SAB - CONTINUATION OF RELEASE FUNCTION ;8:44 AM  30 Mar 2014
	;;7.0;OUTPATIENT PHARMACY;**15,13,9,27,67,71,156,118,148,247,200,385,WVEHR,LOCAL**;DEC 1997;Build 3
	;
...
QTY	; Refill Release
	...
	;was;W:'$G(IFN) !?7,"No "_$S($G(XTYPE):"Refill(s)",1:"Partial(s)")_" to be Released"
	I $G(PSOAFYN)'="Y" W:'$G(IFN) !?7,"No "_$S($G(XTYPE):"Refill(s)",1:"Partial(s)")_" to be Released"
