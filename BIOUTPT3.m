...
IMMRCV(BIMMR,BIRDT,BIMMRF,BIRTN) ;EP
 ...
 N BIPC S BIPC=$S($$RPMS^BIUTL9():2,1:1)
 D SEL^BISELECT(9999999.14,"BIMMR","Vaccine",,,BIPC,"3;;24",BICOL,.BIPOP)
 ;
 D:'$G(BIPOP)
...
IMMDUE(BIMMD,BIRTN) ;EP
 ...
 N BIPC S BIPC=$S($$RPMS^BIUTL9():2,1:1)
 D SEL^BISELECT(9999999.14,"BIMMD","Vaccine",,,BIPC,"3;;19",BICOL,.BIPOP)
 D @("RESET^"_BIRTN)
 Q
 ;
 ;
