MAGDQR08 ;WOIFO/EdM - Cross-References for Query/Retrieve ; 10/10/2007 07:40
 ;;3.0;IMAGING;**54**;03-July-2009;Build 1;Build 1424
...
UIDS ; Overflow from MAGDQR02
 ...
 . . . . Q
 . . . ; *** MLS/ISI mod. start ***
 . . . I $G(ISISL)="IMAGE" S ^TMP("MAG",$J,"QR",23,I)="",UID=1
 . . . ; *** MLS/ISI mod. end ***
 . . . Q:$P(X,"^",10)
 ...
 ; *** MLS/ISI mod. start ***
SERIES ;
 Q:$G(^MAG(2005,X,"SERIESUID"))=""
 Q:$D(^TMP("MAG",$J,"QR",24,$G(^MAG(2005,X,"SERIESUID"))))
 S ^TMP("MAG",$J,"QR",24,$G(^MAG(2005,X,"SERIESUID")))=""
 S ^TMP("MAG",$J,"QR",22,X)=""
 S UID=1
 Q
 ; *** MLS/ISI mod. end ***
