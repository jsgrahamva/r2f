IBXSA2 ; GENERATED FROM 'IB SCREEN102' INPUT TEMPLATE(#1767), FILE 399;11/04/15
 D DE G BEGIN
...
BEGIN S DNM="IBXSA2",DQ=1
 ...
 M DIEZAR=^DIE(1767,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1767,U="^"
