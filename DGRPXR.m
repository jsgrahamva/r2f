DGRPXR ; GENERATED FROM 'DGRP COLLATERAL REGISTER' INPUT TEMPLATE(#422), FILE 2;08/22/16
 D DE G BEGIN
...
1 S DW="VET;1",DV="SXa",DU="",DLB="VETERAN (Y/N)?",DIFLD=1901
 S DE(DW)="C1^DGRPXR"
 S DU="Y:YES;N:NO;"
 S X="N"
 S Y=X
...
C2F1 N X,X1,X2 S DIXR=799 D C2X1(U) K X2 M X2=X D C2X1("O") K X1 M X1=X
 D
