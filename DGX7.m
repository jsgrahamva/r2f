DGX7 ; GENERATED FROM 'DG701-10D' INPUT TEMPLATE(#1777), FILE 45;11/08/15
 D DE G BEGIN
...
BEGIN S DNM="DGX7",DQ=1
 ...
 M DIEZAR=^DIE(1777,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1777,U="^"
