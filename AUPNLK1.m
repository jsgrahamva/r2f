AUPNLK1	; IHS/CMI/LAB - IHS PATIENT LOOKUP CHECK XREFS ;11:58 AM  23 Jun 2012
	;;1.0;PCE PATIENT CARE ENCOUNTER;**167,WVEHR,LOCAL**;Aug 12, 1996;Build 3
	;
...
IHSB	; CHECK TRANSPOSED OR MISSING FIRST/MIDDLE
	...
	S AUPBX=AUPNML
	;Begin WorldVistA change SO-06/21/2012
	...
	F AUPBI=0:0 Q:AUPDFN  S AUPBX=$O(^DPT("B",AUPBX)) Q:$E($P(AUPBX,",",1),1,$L(AUPNML))'=AUPNML  S AUPBY=$P(AUPBX,",",2) D IHSB2 I Y D  ;SO-06/21/2012
	. F Y=0:0 S Y=$O(^DPT("B",AUPBX,Y)) Q:'Y  I '$D(AUPS(Y)) S AUPVAL=AUPBX,AUPNICK(Y)="" D SETAUP^AUPNLKUT Q:AUPDFN  ;SO-06/21/2012
	;End WorldVistA change SO-06/21/2012
	K AUPBI,AUPBX,AUPBY
	Q
	;
PUNC	;
