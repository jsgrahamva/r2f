DGREG ;ALB/JDS,MRL/PJR/PHH-REGISTER PATIENT ;1 APR 2017
 ;;5.3;Registration;**1,32,108,147,149,182,245,250,513,425,533,574,563,624,658,864,886,915,WVEHR,LOCAL**;Aug 13, 1993;Build 2
 ;
...
A D ENDREG($G(DFN))
 ...
 ;WAS;W !! S DIC=2,DIC(0)="ALEQM",DLAYGO=2 K DIC("S"),DIC("B") D ^DIC K DLAYGO G Q1:Y<0 S (DFN,DA)=+Y,DGNEW=$P(Y,"^",3) N Y D PAUSE^DG10 D BEGINREG(DFN) I DGNEW D NEW^DGRP
 W !!
 ...
 . S DGNEW=$P(Y,"^",3) ; new patient?
    . I DGNEW D NEW^DGRP ; OSE/SMH Apr 1 2017 - "EHR PATIENT" fix.
