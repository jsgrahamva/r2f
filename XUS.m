XUS	;SFISC/STAFF - SIGNON ;4:20 AM  28 Jun 2015
	;;8.0;KERNEL;**16,26,49,59,149,180,265,337,419,434,584,WVEHR,LOCAL**;Jul 10, 1995;Build 1
...
CHECKAV(X1)	;Check A/V code return DUZ or Zero. (Called from XUSRB)
	...
	;
	;Begin WorldVista Change
	;was;S X=$$EN^ROUTINE(X) I '$D(^VA(200,"A",X)) D LBAV Q 0
	S X=$$EN^XUSHSH(X) I '$D(^VA(200,"A",X)) D LBAV Q 0
	S %1="",IEN=$O(^VA(200,"A",X,0)),XUF(.3)=IEN D USER(IEN)
	;was;S X=$P(X1,";",2) S:XUF %1="Verify: "_X S X=$$EN^ROUTINE(X)
