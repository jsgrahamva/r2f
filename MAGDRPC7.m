MAGDRPC7 ;WOIFO/EdM - RPC to fetch a Audit Info ; 10/30/2008 09:20
 ;;3.0;IMAGING;**11,51,54**;03-July-2009;Build 1;Build 1424
...
PURGE(OUT,FM,DATE) ; RPC = MAG DICOM AUDIT PURGE
 ; Purge Audit FIle
 N D0,DAYS,X
 L +^MAGDAUDT(FM):1999999 ; Background job MUST wait
...
COUNT(OUT,LOCATION,MESSAGE) ; RPC = MAG DICOM AUDIT COUNT
 ...
 D:'D2
 . L +^MAGDAUDT(2006.5761,TODAY):1999999 ; Background job MUST wait
...
LOGXIMG(OUT,D0,DEST,LOCATION,STATUS,TO,XMIT,MECH) ; RPC = MAG DICOM ROUTE LOG XMIT
 ...
 L +^MAG(2005,IMG):1999999 ; Background job MUST wait
