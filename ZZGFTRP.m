ZZGFTRP ; REPOINT VOE OFFICE INSTITUTION OLD TO VOE OFFICE INSTITUTION;6:49 PM  26 Sep 2012
...
PUT(XVAL,Y,FIELD) I '$D(GFTIEN(GFTFILE,XVAL)) Q:$G(GFTANY)<2
 ...
 I RPVOE D
 . I FILE'=9999999.06,$P(FIELD,",",2)=.01,^DD($P(FIELD,",",1),$P(FIELD,",",2),0)["DINUM" D  Q  ;HANDLE DINUMED SUBFILE ENTRIES
 .. N TARGET,FROM
