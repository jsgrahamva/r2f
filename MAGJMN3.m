MAGJMN3 ;WIRMFO/JHC VRad Maint functions ; 27-Jan 2014  7:52 PM
 ;;3.0;IMAGING;**18**;Mar 07, 2006;Build 2
 ;; +---------------------------------------------------------------+
...
EECPT ;Enter/Edit CPT MATCHING SET
 W @IOF,!!?10,"** Enter/Edit ISI Rad RAD CPT MATCHING CPT CODE **",!!
 N MAGIEN
...
INCPT ; Inquire MAG RAD CPT MATCHING
 W @IOF,!!?10,"** Inquire ISI Rad CPT MATCHING CPT CODE **",!!
 N MAGIEN,BY,FR,TO
...
PRCPT ;Print MAG RAD CPT MATCHING LOGIC
 N FLDS
 W @IOF,!!?10,"** Print ISI Rad CPT MATCHING CPT CODE **",!!
