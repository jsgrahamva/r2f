MAGDHWA ;WOIFO/PMK - Capture Consult/Request data ; 12 Jul 2005  2:32 PM
 ;;3.0;IMAGING;**10,51,50**;26-May-2006;Build 2
 ;; +---------------------------------------------------------------+
...
OBR ; update OBR segment
 ...
 . ;************ ISI update to add CPT to Procedure requests
 . N CODE,CODENAME,OBR4
 . S Z=$S($P(X,DEL,4)["PHH CATH PROCEDURE":"93547^HEART CATHETER & ANGIOGRAM",1:"")
 . I Z D
 . . S CODE=$P(Z,"^",1),CODENAME=$P(Z,"^",2)
 . . S OBR4=$P(X,DEL,4)
 . . S $P(OBR4,DEL2,1)=CODE
 . . S $P(OBR4,DEL2,2)=CODENAME
 . . S $P(X,DEL,4)=OBR4
 . ;************ End ISI update *********
 . D SAVESEG^MAGDHW0(I,X)
 . Q
