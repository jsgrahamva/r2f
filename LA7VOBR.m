LA7VOBR	;DALOI/JMC - LAB OBR segment builder ;01/27/15  21:31
...
OBR29(LA7PON,LA7FON,LA7FS,LA7ECH)	      ; Build OBR-29 sequence - Parent
	...
	;
	;
	; Begin WorldVistA Change JCM - OBR31 added
OBR31(LA7ORIFN,LA7FS,LA7ECH)	; Build OBR-31 sequence -Reason for Study field :wv
	; Call with LA7ORIFN = CPRS order entry in #100
	;              LA7FS = HL field separator
	;             LA7ECH = HL encoding characters
	;
	; Returns OBR-31 sequence
	;
	N DXIEN,ICD9,ICDR,LA7RFS,OCT,ORFMDAT,ORIFN,TEXT
	D OBR31^LA7VOBRA
	Q LA7RFS
