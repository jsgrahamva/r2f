IBXS3 ; GENERATED FROM 'IB SCREEN3' INPUT TEMPLATE(#574), FILE 399;11/04/15
 D DE G BEGIN
...
C7S S X="" G:DG(DQ)=X C7F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D ATTREND^IBCU1(DA,"","")
C7F1 N X,X1,X2 S DIXR=933 D C7X1(U) K X2 M X2=X D C7X1("O") K X1 M X1=X
 K X M X=X2 D
...
C7X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C7F2 S DIXR=934 D C7X2(U) K X2 M X2=X D C7X2("O") K X1 M X1=X
 K X M X=X2 D
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D ATTREND^IBCU1(DA,"","")
C11F1 N X,X1,X2 S DIXR=933 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 K X M X=X2 D
 . N IBLNPRV I $$LNPRVFT^IBCEU7(X,.IBLNPRV) D FILE^DIE("E","IBLNPRV") Q
 G C11F2
C11X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C11F2 S DIXR=934 D C11X2(U) K X2 M X2=X D C11X2("O") K X1 M X1=X
 K X M X=X2 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . S X=X(1)=3
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
