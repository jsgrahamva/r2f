PRCBR1	;WISC@ALTOONA/CTB-ROUTINE TO RELEASE TRANSACTIONS FROM FUND DISTRIBUTION FILE ;1:37 PM  9 Aug 2015
V	;;5.1;IFCAP;**139,170,WVEHR,LOCAL**;Oct 20, 2000;Build 2
...
LOCK	;LOCK GLOBAL THAT IS BEING ACCESSED BY ANOTHER USER
	...
	;WAS;L +@(DIC_DA_")"):$G(DILOCKTM,3) S PRSAL=$T Q:PRSAL'=0  I PRSAL=0 W !!,$C(7),"THIS ENTRY IS BEING EDITED BY ANOTHER USER.  TRY LATER." Q
	N WV S VW=DIC_DA_")"
	L +@(DIC_DA_")"):$S($G(DILOCKTM):DILOCKTM,1:3) S PRSAL=$T Q:PRSAL'=0  I PRSAL=0 W !!,$C(7),"THIS ENTRY IS BEING EDITED BY ANOTHER USER.  TRY LATER." Q
