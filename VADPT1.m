VADPT1	;ALB/MRL/MJK,ERC,TDM - PATIENT VARIABLES ;9:54 AM  4 Feb 2014
	;;5.3;Registration;**415,489,516,614,688,754,WVEHR,LOCAL**;Aug 13, 1993;Build 3
	;
...
1	;Demographic [DEM]
	...
	;Begin WorldVistA Change ;VW*1.0*250003
	D
	. N Z D BRFAGE^VWTIME(.Z,DFN)
	. S @VAV@($P(VAS,"^",4))=Z
	. Q
