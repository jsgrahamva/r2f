DGRPCE	;ALB/MRL,KV,PJR,BRM,ERC,TDM,LBD - CONSISTENCY CHECKER, EDIT INCONSISTENCIES ;6:11 AM  2 Apr 2014
	;;5.3;Registration;**121,122,175,297,342,451,626,689,653,754,797,WVEHR,LOCAL**;Aug 13, 1993;Build 3
	;
	;
	...
	;Begin WorldVistA change ;so 3/10/2012
	G NKEY:$G(DUZ("AG"))="E"
...
ELDR	S DGASK=DGASK_"9,10,11,12,13,14,18,19,20,24,29,30,31,34,36,37,38,"
	...
	;was;I 'DGKEY(1) S DGD="391;1901;S DGVTYN=$S($D(^DPT(DFN,""VET"")):$P(^(""VET""),""^"",1),1:"""");S:X'=""Y"" Y=""@1"";.301;S:X'=""Y"" Y=""@1"";.302;@1;" D SAVE
	;was;I 'DGKEY(2) F I=29,30,31 S DGD=$P($T(@I),";;",2,999) D SAVE
	;was;D:DGD]"" SAVE I 'DGKEY(3) S DGD=$P($T(34),";;",2,999) D SAVE S DGD=$P($T(51),";;",2,999) D SAVE
