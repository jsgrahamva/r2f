LA7VORM4	;DALOI/DLR - LAB ORM (Order) message builder ;01/27/15  21:35
	;;5.2;AUTOMATED LAB INSTRUMENTS;**73,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 6
	;
...
XAD(LA7FN,LA7DA,LA7DT,LA7FS,LA7ECH)	; Build extended address
	...
	;
	;
ORIFN(LRAA,LRAD,LRAN,LR60)	; Find accession's related CPRS order number (ORIFN)
	;
	...
	;           LR60 = lab test on accession (pointer to file #60)
	;
	...
	I $P(LA7X,"^",2)=2,LRODT,LRSN D
	. I LR60 S LRORIFN=$P($G(^LRO(69,LRODT,1,LRSN,2,LR60,0)),"^",7) ; CPRS order # from test
	. I LRORIFN>0 Q  ; return CPRS order # from test
	. S LRORIFN=$P($G(^LRO(69,LRODT,1,LRSN,0)),"^",11) ; CPRS order # from lab order if not found on test.
	;
	Q LRORIFN
