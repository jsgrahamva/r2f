ORCACT01	;SLC/MKB-Validate order actions cont ;6:54 AM  7 Sep 2015
	;;3.0;ORDER ENTRY/RESULTS REPORTING;**94,116,134,141,163,187,190,213,243,306,374,WVEHR,LOCAL**;Dec 17, 1997;Build 1
	;
...
ES1	I PKG="PS" D  ;authorized to write meds?
	...
	. ;WAS;I (DEAFLG>0||$$ISCLOZ^ORALWORD(OI)) D  I $G(ERROR)]"" Q
	. I $S(DEAFLG>0:1,$$ISCLOZ^ORALWORD(OI):1,1:0) D  I $G(ERROR)]"" Q
