PSOORNE4	;BIR/SAB-display renew RXs from backdoor ;2:38 PM  7 Sep 2015
	;;7.0;OUTPATIENT PHARMACY;**11,27,32,36,46,75,96,103,99,117,131,225,386,390,391,313,WVEHR,LOCAL**;DEC 1997;Build 4
	;
...
EN1	K PSOQUIT D:$G(PSONEW("ENT"))'>0  I $G(PSORENW("POE"))=1 S PSOREEDT=1 D SV
	...
	;WAS;RDD     D DSPL,^PSOLMRN D:$G(PKI1)=2 DCP^PSOPKIV1 I $G(PSORX("FN")) S VALMBCK="Q" K PSOREEDT Q
