MAGDRPC9 ;WOIFO/EdM - Imaging RPCs ; 05 Sep 2008 12:55 PM
 ;;3.0;IMAGING;**50,54,53**;Mar 19, 2002;Build 1;Apr 28, 2010
...
NEWUID(OUT,OLD,NEW,IMAGE) ; RPC = MAG NEW SOP INSTANCE UID
 ...
 L +^MAG(2005,"P"):1999999 ; Background process MUST wait
 S OUT="" F  D  Q:OUT'=""
 . S OUT=L_X
...
QRNEWUID(IMAGE) ; Get updated UID for Query/Retrieve
 ...
 L +^MAGDICOM(2006.563,1,"MACHINE ID"):1999999 ; Background process must wait
...
CLEAN ; Overflow from MAGDRPC4
 ...
 L +^MAGDOUTP(2006.574,S0,1,0):1999999 ; Background process MUST wait
 ...
 L +^MAGDOUTP(2006.574,0):1999999 ; Background process MUST wait
