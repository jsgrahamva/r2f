XUSAP	;ISF/RWF - PROXY User Tools ;08/16/2006
	;;8.0;KERNEL;**361,425,LOCAL,WVEHR**;Jul 10, 1995;Build 2
	Q
	;
...
CREATE(NAME,FMAC,OPT,NIL)	;Create an APPLICATION PROXY user
	...
	;BEGIN WorldVistA Change 8/1/2015 WVEHR/DJW ; fix Cacheism
	;was; I END Q "0^Name in Use"
	I IEN Q:$Q "0^Name in Use" Q
	...
	D ^DIC S IEN=+Y
	;BEGIN WorldVistA Change 8/1/2015 WVEHR/DJW ; fix Cacheism
	;was; I IEN<0 Q -1 ;Failed to create
	I IEN<0 Q:$Q -1 Q  ;Failed to create
	;END WorldVistA Change
	...
	;BEGIN WorldVistA Change 8/1/2015 WVEHR/DJW ; fix Cacheism
	;was ;I $D(^TMP("DIERR",$J)) Q -1
	;was ;Q IEN
	I $D(^TMP("DIERR",$J)) Q:$Q -1 Q
	Q:$Q IEN Q
	;END WorldVistA Change
	;
