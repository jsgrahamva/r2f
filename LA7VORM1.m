LA7VORM1	;DALOI/DLR - LAB ORM (Order) message builder ;01/27/15  21:35
	;;5.2;AUTOMATED LAB INSTRUMENTS;**27,51,46,61,64,68,74,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 6
	; 
	; This routine not in FOIA VistA.
	       ;
...
BUILD(LA7628)	;
	...
	. ; Begin WorldVistA Changes JMC see lines with comment ;WV at the end
	. ;N LA7PID,LA7PV1 ;WV
	. N LA7PID,LA7PV1,LA7ORIFN ;WV
	. I LA7SMSG=1 D STARTMSG Q:$G(HL)
	. ;I LA7SMSG<2 D PID,PV1 ;WV
	. I LA7SMSG<2 D PID,PV1 D:DUZ("AG")="E" IN1^LA7VORM4 ;WV
	. S LA7UID=""
	...
	. . E  S LA76802(5)=""
	. . ;I LA7SMSG=2 D STARTMSG Q:$G(HL)  D PID,PV1 ;WV
	. . I LA7SMSG=2 D STARTMSG Q:$G(HL)  D PID,PV1 D:DUZ("AG")="E" IN1^LA7VORM4 ;WV
	...
	. . . I DUZ("AG")="E" S LA7ORIFN=$$ORIFN^LA7VORM4(LRAA,LRAD,LRAN,LA762801) ;WV check for VOE
	. . . D ORC,OBR^LA7VORM3,OBX^LA7VORM3,BLG
	. . ; check for VOE before inserting Diagnosis code ;WV
	. . I DUZ("AG")="E",$G(LA7ORIFN)'="" D DG1^LA7VORM4(LA7ORIFN) ;WV
	. . ; End WorldVistA Changes
