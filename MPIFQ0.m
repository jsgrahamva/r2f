MPIFQ0	;ALB/RJS-QUERY HANDLER TOP LEVEL ;8:15 AM  8 Nov 2015
	;;1.0;MASTER PATIENT INDEX VISTA;**1,3,8,14,13,16,17,21,20,24,26,28,31,33,35,38,43,52,54,56,60,WVEHR,LOCAL**;30 Apr 99;Build 1
	;
...
VTQ	G:$G(DFN)']"" END
	...
	;Begin WorldVistA patch
	I '($G(DUZ("AG"))="V"!$$GET^XPAR("SYS","MPIF VOE MPI")) G END
