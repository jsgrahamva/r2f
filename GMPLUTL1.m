GMPLUTL1	; SLC/MKB/KER/TC -- PL Utilities (cont) ;6:28 AM  7 Sep 2015
	;;2.0;Problem List;**3,8,7,9,26,35,39,36,42,WVEHR,LOCAL**;Aug 25, 1994;Build 1
	;
...
DIAGNOSI	; ICD Diagnosis Pointer
	...
	;WAS;S:'$L($G(PL("DIAGNOSIS"))) PL("DIAGNOSIS")=$$NOS^GMPLX
	S:'$L($G(PL("DIAGNOSIS"))) PL("DIAGNOSIS")=$$NOS^GMPLX Q:'GMPVA
...
LOCATION	; Hospital Location (Clinic) Pointer
	;Begin WorldVistA change
	;WAS;S:'$D(PL("LOCATION")) PL("LOCATION")="" Q:'$L(PL("LOCATION"))
	S:'$D(PL("LOCATION")) PL("LOCATION")="" Q:'$L(PL("LOCATION"))  Q:'GMPVA
	;End WorldVistA change
...
PROVIDER	; Responsible Provider
	;Begin WorldVistA change
	;WAS;S:'$D(PL("PROVIDER")) PL("PROVIDER")=""
	S:'$D(PL("PROVIDER")) PL("PROVIDER")="" Q:'GMPVA
	;End WorldVistA change
...
STATUS	; Problem Status
	;Begin WorldVistA change
	;WAS;S:$G(PL("STATUS"))="" PL("STATUS")="A"
	S:$G(PL("STATUS"))="" PL("STATUS")="A" Q:'GMPVA
	;End WorldVistA change
...
ONSET	; Date of Onset
	N %DT,Y,X
	;Begin WorldVistA change
	;WAS;S:'$D(PL("ONSET")) PL("ONSET")="" Q:'$L(PL("ONSET"))
	S:'$D(PL("ONSET")) PL("ONSET")="" Q:'$L(PL("ONSET"))  Q:'GMPVA
	;End WorldVistA change
...
HNC	; HNC/NTR exposure flag (Requires GMPHNC)
	;Begin WorldVistA change
	;WAS;S:'$D(PL("HNC")) PL("HNC")=""
	S:'$D(PL("HNC")) PL("HNC")="" Q:'GMPVA
	;End WorldVistA change
...
MST	; MST exposure flag (Requires GMPMST)
	;Begin WorldVistA change
	;WAS;S:'$D(PL("MST")) PL("MST")=""
	S:'$D(PL("MST")) PL("MST")="" Q:'GMPVA
	;End WorldVistA change
