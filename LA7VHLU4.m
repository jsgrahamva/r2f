LA7VHLU4	;DALOI/JMC - HL7 segment builder utility ;01/27/15  21:29
	;;5.2;AUTOMATED LAB INSTRUMENTS;**46,64,68,74,250005,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 6
...
XON(LA7FN,LA7DA,LA7TYP,LA7FS,LA7ECH)	; Build extended composite name/id for organization
	...
	.; Begin WorldVistA Change Added this section JMC
	. I $G(LA7INTYP)=80 D
...
PLTFM(LA7PL,LA7FS,LA7ECH)	; Resolve location from PL (person location) data type.
	...
	;
	;
	; Begin WorldVistA Change Added next tag JMC
