PSOREF	;BIR/SAB-refill data entry ;2:59 PM  7 Sep 2015
	;;7.0;OUTPATIENT PHARMACY;**1,23,27,36,46,78,130,131,148,206,313,WVEHR,LOCAL**;DEC 1997;Build 4
	;
...
SPEED	;speed refill
	...
	..D ^DIC K DIC
	..S PSOZAF=+Y
	..I $P($G(^PSRX($P(PSOLST(ORN),"^",2),"OR1")),"^",5)=$G(PSOZAF) W $C(7),!!,"Rx "_$$GET1^DIQ(52,$P(PSOLST(ORN),"^",2),.01)_" is an Autofinish,Rx and can not be refilled" K PSOZAF D PAUSE^VALM1 Q
	..;End WorldVistA change
