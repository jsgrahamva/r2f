PSSHRIT	;WOIFO/SG,PO - Transmits a "ping" to determine if FDB server is down and record the down time ;3:22 PM  8 Sep 2015
	;;1.0;PHARMACY DATA MANAGEMENT;**136,168,164,173,180,WVEHR,LOCAL**;9/30/97;Build 1
	;
