DGREGAED	;ALB/DW/PHH,BAJ,TDM - Address Edit API;9:27 AM  17 Feb 2016; 4/2/09 2:29pm
	;;5.3;Registration;**522,560,658,730,688,808,915,WVEHR,LOCAL**;Aug 13, 1993;Build 1
	;;
...
INPT1(FORGN,PSTR)	; first address input prompts
	...
	;Begin WorldVistA change
	;WAS;S PSTR=".111,.112,.113,.114,.115,.117,.1112,.1171,.1172,.1173,.131,.132,.121"
	;WAS;S FSTR=".111,.112,.113,.1112,.131,.132,.121"
	;WAS;I FORGN S FSTR=".111,.112,.113,.114,.1171,.1172,.131,.132,.121"
