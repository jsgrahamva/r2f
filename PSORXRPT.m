PSORXRPT	;BIR/SAB-reprint of a prescription label ;11:04 AM  2 Apr 2014
	;;7.0;OUTPATIENT PHARMACY;**3,21,27,34,120,138,156,148,280,367,WVEHR,LOCAL**;DEC 1997;Build 3
	;
...
BCK	I $G(PSOBEDT) W $C(7),$C(7) S VALMSG="Invalid Action at this time !",VALMBCK="" Q
	...
	S PSOZAF=+Y
	I $P($G(^PSRX(RX,"OR1")),"^",5)=$G(PSOZAF) S VALMBCK="",VALMSG="This reprint option is not available for Autofinshed Rxs",QFLG=1 K PSOZAF D ULR,KILL Q
