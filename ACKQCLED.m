ACKQCLED	;SMT - ACKQ CLINICIAN EDIT MENU ;5:50 AM  4 Mar 2012; 9/22/09 8:48am
	;;3.0;QUASAR;**17,WVEHR,LOCAL**;Nov 10, 2007;Build 3
	;
...
PCCHK(NPIEN)	;Check if User has a PERSON CLASS valid to QUASAR.
	...
	. ;Begin WorldVistA change ;so 03/04/2012
	. ;was;I (EFDT<=TODAY),(+EXPDT=0)!(EXPDT>TODAY) S RETRN=1
...
USRCHK(NPNM)	;Check if User has valid USR Class
	...
	. ;Begin WorldVistA change ;so 03/04/2012
	. ;was;I +$$GET1^DIQ(8930.3,USRIEN,".04","I")<=TODAY,+$$GET1^DIQ(8930.3,USRIEN,".04","I")>0 S RETRN=0
