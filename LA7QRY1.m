LA7QRY1	;DALOI/JMC - Lab HL7 Query Utility ; Jun 25, 2012
	;;5.2;AUTOMATED LAB INSTRUMENTS;**46,61,68,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 3
	;
...
BUILDMSG	; Build HL7 message with result of query
	...
	N LA,LA763,LA7ID,LA7NTESN,LA7NVAF,LA7OBRSN,LA7OBXSN,LA7PIDSN,LA7QUIT,LA7ROOT,LA7SFT,LA7X,LRIDT,LRPOC,LRSS,X
	;
	...
	;
	; Build SFT segment for MU interfaces
	;I $G(LA7INTYP)=80 D
	;. S LA7SFT(0)=$$SFT^VWHLUT(LA7FS,LA7ECH)
	;. D FILESEG^LA7VHLU(GBL,.LA7SFT)
	;. I '$G(LA7NOMSG),$G(LA76249) D FILE6249^LA7VHLU(LA76249,.LA7SFT)
	;
...
PAT	; Build PID/PV1 segments
	...
	. ;I $G(LA7INTYP)=80 D KLUGE^LA7MU1(.LA7,DFN)
	. S I=0
