DGRPTX ; GENERATED FROM 'DGRPT 10-10T REGISTRATION' INPUT TEMPLATE(#1476), FILE 2;08/22/16
 D DE G BEGIN
...
C3F1 N X,X1,X2 S DIXR=795 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
