XINDX2	;ISC/REL,GRK,RWF - PROCESS "GRB" ;4/2/08  16:35
	;;7.3;TOOLKIT;**20,27,48,110,121,133,LOCAL,WVEHR**;Apr 25, 1995;Build 2
...
ARG	;Process one argument
	...
	;BEGIN WorldVistA mod 7/2015 DJW/WVEHR
	;was; I $D(LV(LV,"OBJ",LI)) G OBJ2:CH=".",OBJ1
	I $$ISCACHE,$D(LV(LV,"OBJ",LI)) G OBJ2:CH=".",OBJ1
	;was; I CH="#",$E(S,1,2)="##" D OBJ Q
	I $$ISCACHE,CH="#",$E(S,1,2)="##" D OBJ Q
	;END WorldVistA MOD 
...
OBJTST(OBJ)	;test if OBJ exists, returns 1 if exists
	...
	;
	;BEGIN WorldVistA mod 7/2015 DJW/WVEHR
ISCACHE()	; returns tval(is this a Cache or Open M system?)
	Q ^%ZOSF("OS")["OpenM"!(+^%ZOSF("OS")=3)
	;END WorldVistA MOD
