DGMTXT ; GENERATED FROM 'DGMT V1 ENTER/EDIT DEPENDENTS' INPUT TEMPLATE(#1730), FILE 408.22;08/09/16
 D DE G BEGIN
...
BEGIN S DNM="DGMTXT",DQ=1
 ...
 M DIEZAR=^DIE(1730,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1730,U="^"
