ORWPT	; SLC/KCM/REV - Patient Lookup Functions ;3:11 AM  23 Aug 2015
	;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,132,149,206,187,190,215,243,280,306,311,WVEHR,LOCAL**;Dec 17, 1997;Build 2
	;
...
IDINFO(REC,DFN)	; Return identifying information for a patient
	...
	;WAS;S REC=$$SSN^DPTLK1(DFN)_U_$$DOB^DPTLK1(DFN,2)_U_$P(X0,U,2)_U_$P(XV,U)_U_$P(X3,U,2)_U_$P(X1,U)_U_$P(X101,U)_U_$P(X0,U) ;DG249
...
HRNRET(DFN)	;
	;
	N IRET S IRET=$$HRN^DGLBPID(DFN) ;$$HRN^VWVOEDPT(DFN)
