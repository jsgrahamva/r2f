PXRMPSN	;SLC/PKR - Process PSN protocol events. ;02/10/2011
	;;2.0;CLINICAL REMINDERS;**12,17,16,18,22,WVEHR,LOCAL**;Feb 04, 2005;Build 2
	;
...
EVDRVR	;Event driver for PSN events.
	...
	;
	S VAPRODIEN=0
	;Begin WorldVistA Change ; DJW 8-6-2015
	;If "B" found as VAPRODIEN then Quit
	;Was F  S VAPRODIEN=$O(^XTMP(EVENT,VAPRODIEN)) Q:VAPRODIEN=""  D
	F  S VAPRODIEN=$O(^XTMP(EVENT,VAPRODIEN)) Q:VAPRODIEN<1   D
