MAGGSIU2 ;WOIFO/GEK/NST - Utilities for Image Add/Modify ; 20 May 2010 1:42 PM
 ;;3.0;IMAGING;**7,8,85,59,108**;Mar 19, 2002;Build 2;May 20, 2010
...
MAKEFDA(MAGGFDA,MAGARRAY,MAGACT,MAGCHLD,MAGGRP,MAGGWP) ;
 ...
 . ;
 . I MAGGFLD=5,MAGGDAT["H" S MAGGDAT=$O(^AUPNPAT("D",$P(MAGGDAT,"H",2),""))  ;Convert HRN to DFN if an number has a leading "H"
 . ;
