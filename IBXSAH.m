IBXSAH ; GENERATED FROM 'IB SCREEN10H' INPUT TEMPLATE(#1768), FILE 399;11/04/15
 D DE G BEGIN
...
BEGIN S DNM="IBXSAH",DQ=1
 ...
 M DIEZAR=^DIE(1768,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1768,U="^"
