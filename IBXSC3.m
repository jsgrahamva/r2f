IBXSC3 ; GENERATED FROM 'IB SCREEN3' INPUT TEMPLATE(#574), FILE 399;02/01/12
 D DE G BEGIN
DE S DIE="^DGCR(399,",DIC=DIE,DP=399,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGCR(399,DA,""))=""
 ...
 I $D(^("M")) S %Z=^("M") S %=$P(%Z,U,12) S:%]"" DE(22)=% S %=$P(%Z,U,13) S:%]"" DE(25)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
25 D:$D(DG)>9 F^DIE17,DE S DQ=25,DW="M;13",DV="FOX",DU="",DLB="SECONDARY INSURANCE POLICY",DIFLD=113
 ...
 S DE(DW)="C25^IBXSC3",DE(DW,"INDEX")=1
 G RE
