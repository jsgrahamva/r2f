...
MORE ;REINDEXING
 ;now the APD
 ;
 ;  FIX ERROR IN FILE 56
 ;
 I $L($G(^PS(56,513,0))),'$L($P(^PS(56,513,0),"^",2)) S $P(^PS(56,513,0),"^",2)=2779
 I $L($G(^PS(56,513,0))),'$L($P(^PS(56,513,0),"^",3)) S $P(^PS(56,513,0),"^",3)=255
 I $L($G(^PS(56,531,0))),'$L($P(^PS(56,531,0),"^",2)) S $P(^PS(56,531,0),"^",2)=3183
 I $L($G(^PS(56,531,0))),'$L($P(^PS(56,531,0),"^",3)) S $P(^PS(56,531,0),"^",3)=255
 I $L($G(^PS(56,1961,0))),'$L($P(^PS(56,1961,0),"^",2)) S $P(^PS(56,1961,0),"^",2)=255
 I $L($G(^PS(56,1961,0))),'$L($P(^PS(56,1961,0),"^",3)) S $P(^PS(56,1961,0),"^",3)=3150
 ;
