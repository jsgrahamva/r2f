LA7VHLU9	;DALOI/JMC - HL7 segment builder utility ;01/27/15  21:29
	;;5.2;AUTOMATED LAB INSTRUMENTS;**68,74,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 6
	;
...
XCN(LA7DUZ,LA7DIV,LA7FS,LA7ECH,LA7DMT,LA7IDTYP)	; Build composite ID and name for person
	...
	. . ;I $G(LA7INTYP)=80 S $P(LA7Y,LA7CS,8)="L",$P(LA7Y,$E(LA7ECH,1),9)="WVEHR"_$E(LA7ECH,4)_"2.16.840.1.113883.3.543"_$E(LA7ECH,4)_"ISO" ;WV
