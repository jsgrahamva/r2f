MAGGSIV ;WOIFO/GEK/NST - Imaging RPC Broker calls. Validate Image data array ; 12 Apr 2010 12:52 PM
 ;;3.0;IMAGING;**7,8,20,59,108**;Mar 19, 2002;Build 2;May 20, 2010
...
VAL(MAGRY,MAGARRAY,ALL) ;RPC [MAG4 VALIDATE DATA]
 ...
 . I MAGGFLD=5 S DFNFLAG=1 I MAGGDAT["H" S MAGGDAT=$O(^AUPNPAT("D",$P(MAGGDAT,"H",2),""))  ;Convert HRN to DFN if an number has a leading "H"
