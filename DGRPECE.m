DGRPECE	;ALB/MRY,ERC,BAJ - REGISTRATION CATASTROPHIC EDITS ;11:30 AM  31 Dec 2013
	;;5.3;Registration;**638,682,700,720,653,688,750,831,WVEHR,LOCAL**;Aug 13, 1993;Build 3
	;
	;
...
DOB	;buffer - get dob
	S DIR(0)="2,.03^^"
	S DA=DFN D ^DIR
	;Begin WorldViatA change ;DG*5.3*634
	;was;I $D(DIRUT) D CECHECK Q
	I $D(DIRUT),DUZ("AG")="V" D CECHECK Q
	I $D(DTOUT)!$D(DUOUT) D CECHECK Q
	;End WorldVistA Change
