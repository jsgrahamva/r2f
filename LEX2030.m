LEX2030	;ISL/KER - Environment Check/Pre/Post Install ; 08/04/2004
	;;2.0;LEXICON UTILITY;**30**;Sep 23, 1996;Build 1
	;
	; External References
	;   DBIA 10015  EN^DIQ1
...
ENV	; LEX*2.0*30 Environment Check
	...
	W !," LEX - Lexicon Code Text Descriptors (CTD)",!
	D IMP S U="^"
	;     No user
...
ABRT	;     Abort  Failed Environment Check, KILL the distribution
	D:$D(LEXE) ED S XPDABORT=1,XPDQUIT=1,XPDQUIT("LEX*2.0*30")=1
...
CPD(X)	;   Check Current Patched Data is installed
	...
	S:'$D(^ICD(1,68,"B")) INS=0
	S:$G(^ICD9(13826,66,1,"DRG"))'["248" INS=0
	;     ICPT
...
ED	;   Error Display
	...
	;
IMP	;   Import names
	S LEXLREV=16,LEXREQP="ICD*18.0*7;ICD*18.0*11;ICPT*6.0*16;LEX*2.0*29",LEXBUILD="LEX*2.0*30"
	S LEXIGHF="LEX20_30.GBL"
	Q
