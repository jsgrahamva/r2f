LA7VMSG1	;DALOI/JMC - LAB ORU (Observation Result) message builder cont'd ;01/27/15  21:31
	;;5.2;AUTOMATED LAB INSTRUMENTS;**56,46,61,64,68,74,250068,WVEHR,LOCAL**;Sep 27, 1994;Build 6
	;
	; Not currently Modified from FOIA VISTA,
	Q
	;
...
STARTMSG	; Initialize a HL7 message and variables
	...
	I $G(HL) S LA7END=1
	;
	; Build SFT segment ;WV
	;S LA7SFT(0)=$$SFT^VWHLUT(LA7FS,LA7ECH) ;WV
	;D FILESEG^LA7VHLU(GBL,.LA7SFT) ;WWV
	;D FILE6249^LA7VHLU(LA76249,.LA7SFT) ;WV
	;
	Q
	;
	;
